<script>
    layui.use(['jquery','element','table','laytpl'], function() {
        ...
        table.on('tool(fb-table)', function(obj){
            ...
            }else if(obj.event === 'show_can_cooperative_airports'){
                var html = "<div style='padding: 10px'>"  ;
                $.each(data.can_cooperative_airports,function (key ,val) {
                    html += "<p>"+val.name+"</p>"
                })
                html += "</div>";
                layer.open({
                    ...
                    area: ['420px', '240px'], //宽高,
                    title:'<?php echo e(trans('app.details')); ?>',
                    content: html,
                    shadeClose:true,
                    success:function () {
                        element.init();
            ...
            }else if(obj.event === 'show_cooperative_airports'){
                var html = "<div style='padding: 10px'>"  ;
                $.each(data.cooperative_airports,function (key ,val) {
                    html += "<p>"+val.name+"</p>"
                })
                html += "</div>";
                layer.open({
