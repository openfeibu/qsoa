...
<div class="fb-error">
    ...
    <div class="fb-error-button"><a id="href" <?php if(isset($url) && $url): ?> href="<?php echo e($url); ?>" <?php else: ?> href="javascript:history.back();" <?php endif; ?> >返回上一页(<span id="wait">5</span>s)</a></div>
