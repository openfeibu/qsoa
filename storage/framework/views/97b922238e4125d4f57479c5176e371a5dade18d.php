<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a href="<?php echo e(guard_url('airline')); ?>"><cite><?php echo e(trans('airline.title')); ?></cite></a>
        </div>
    </div>
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('airline/create')); ?>"><?php echo e(trans('app.add')); ?></a></button>
                    <button class="layui-btn layui-btn-primary " data-type="del" data-events="del"><?php echo e(trans('app.delete')); ?></button>
                </div>
                <div class="layui-inline">
                    <input class="layui-input search_key" name="search_name" id="demoReload" placeholder="<?php echo e(trans('airline.label.name')); ?>" autocomplete="off">
                </div>
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-sm" href="<?php echo e(guard_url('airline_contract/create?airline_id=')); ?>{{d.id}}">增加合作机场</a>
...
<script>
    var main_url = "<?php echo e(guard_url('airline')); ?>";
    var delete_all_url = "<?php echo e(guard_url('airline/destroyAll')); ?>";
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            elem: '#fb-table'
            ,url: '<?php echo e(guard_url('airline')); ?>'
            ,cols: [[
                {checkbox: true, fixed: 'left'}
                ,{field:'id',title:'ID', width:80, sort: true}
                ,{field:'name',title:'<?php echo e(trans('airline.label.name')); ?>', width:100,edit:'text'}
                ,{field:'leader',title:'<?php echo e(trans('airline.label.leader')); ?>', width:100,edit:'text'}
                ,{field:'tel',title:'<?php echo e(trans('airline.label.tel')); ?>', width:100,edit:'text'}
                ,{field:'email',title:'<?php echo e(trans('airline.label.email')); ?>', width:100,edit:'text'}
                ,{field:'position',title:'<?php echo e(trans('airline.label.position')); ?>', width:100,edit:'text'}
