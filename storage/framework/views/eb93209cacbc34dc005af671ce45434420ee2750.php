    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('airline_bill/pay/'.$airline_bill->id)); ?>" method="post" lay-filter="fb-form">

                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans('airline_bill.label.paid_date')); ?></label>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans('airline_bill.label.paid_total')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="paid_total" lay-verify="required|number" autocomplete="off" placeholder="" class="layui-input" value="<?php echo e($airline_bill->final_total); ?>" >
                        </div>
                    </div>
