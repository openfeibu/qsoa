                    ...
                    <div class="layui-form-item">
                        <table lay-filter="supplier_bill_item" id="supplier_bill_item">
                            ...
                            <tr>
                                ...
                                <th lay-data="{fixed:'right', align: 'right',toolbar:'#barDemo',width:'100'}"><?php echo e(trans('app.actions')); ?></th>
                            </tr>
                            </thead>
                            <tbody>
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-sm" href="<?php echo e(guard_url('supplier_bill_item')); ?>/{{ d.id }}?type=bill"><?php echo e(trans('app.edit')); ?></a>
</script>
...
<script>
    layui.use(['jquery','element','table','laydate'], function(){
        ...
        laydate.render({
            elem: '#invoice_date'
            ,type: 'date'
            ,value:"<?php echo $supplier_bill->invoice_date; ?>"
        });
        laydate.render({
            elem: '#pay_date'
            ,type: 'date'
            ,value:"<?php echo $supplier_bill->pay_date; ?>"
        });
