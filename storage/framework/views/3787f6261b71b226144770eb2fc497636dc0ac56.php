<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a href="<?php echo e(guard_url('supplier_user')); ?>"><cite><?php echo e(trans("supplier_user.title")); ?></cite></a><span lay-separator="">/</span>
    ...
    <div class="main_full">
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('supplier_user')); ?>" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans("supplier_user.name")); ?></label>
                        <div class="layui-input-inline">
                            <select name="supplier_id">
                                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($supplier->id); ?>" <?php if($supplier->id == $supplier_user->supplier_id): ?> selected <?php endif; ?>><?php echo e($supplier->name); ?></option>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans("supplier_user.label.password")); ?></label>
                        <div class="layui-input-inline">
                            <input type="password" name="password" placeholder="请输入<?php echo e(trans("supplier_user.label.password")); ?>" autocomplete="off" class="layui-input"  lay-verify="required" >
                        </div>
