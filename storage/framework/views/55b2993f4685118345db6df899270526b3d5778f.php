<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite><?php echo e(trans("airline_user.name")); ?></cite></a><span lay-separator="">/</span>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('airline_user/'.$airline_user->id)); ?>" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans("airline_user.name")); ?></label>
                        <div class="layui-input-inline">
                            <select name="airline_id">
                                <?php $__currentLoopData = $airlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $airline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($airline->id); ?>" <?php if($airline->id == $airline_user->airline_id): ?> selected <?php endif; ?> disabled><?php echo e($airline->name); ?></option>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans("airline_user.label.new_password")); ?></label>
                        <div class="layui-input-inline">
                            <input type="password" name="password" placeholder="请输入<?php echo e(trans("airline_user.label.password")); ?>，不改则留空" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="radio" name="roles[]" value="<?php echo e($role->id); ?>" title="<?php echo e($role->name); ?>" <?php echo e(!($airline_user->hasRole($role->slug)) ? :'checked'); ?>>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
