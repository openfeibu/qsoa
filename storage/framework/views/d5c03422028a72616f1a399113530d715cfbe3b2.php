                    ...
                    <div class="layui-form-item level-high">
                        ...
                        <div class="layui-input-inline">
                            <?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="radio" name="airport_id" title="<?php echo e($airport->name); ?>"  value="<?php echo e($airport->id); ?>" lay-filter="airports" lay-verify="otherReq" <?php if($airport['id'] == $supplier_bill_item['airport_id']): ?> checked <?php endif; ?> >
                    ...
                    <div class="layui-form-item level-high">
                        ...
                        <div class="layui-input-inline">
                            <?php $__currentLoopData = $airlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $airline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="radio" name="airline_id" title="<?php echo e($airline->name); ?>"  value="<?php echo e($airline->id); ?>" lay-filter="airlines" lay-verify="otherReq"  <?php if($airline['id'] == $supplier_bill_item['airline_id']): ?> checked <?php endif; ?> >
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
