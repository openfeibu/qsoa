<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a href="<?php echo e(guard_url('airline')); ?>"><cite><?php echo e(trans('airline.title')); ?></cite></a><span lay-separator="">/</span>
    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('airline')); ?>" method="post" lay-filter="fb-form">
