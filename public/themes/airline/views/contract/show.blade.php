    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('contract/'.$contract->id)}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ trans('contract.label.contract_partner') }}</label>
                        <div class="layui-input-inline">
                            <p class="input-p" id="airline_name">{{ $contractable->name }}</p>
                        </div>
                    </div>
