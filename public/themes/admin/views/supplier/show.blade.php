        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('supplier/'.$supplier->id)}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ trans('supplier.label.address') }}</label>
                        <div class="layui-input-inline">
                            <input type="text" name="address" lay-verify="required" autocomplete="off" placeholder="" class="layui-input"  value="{{ $supplier->address }}">
                        </div>
                    </div>
