<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a href="{{ route('supplier_bill_template_field.index') }}"><cite>{{ trans('supplier_bill_template.title') }}</cite></a>
        </div>
    </div>
    <div class="main_full">
...
<div class="add_content" style="display: none">
    <form class="layui-form add_form" action="" style="margin: 10px 10px ">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ trans('supplier_bill_template_field.label.field') }}*</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ trans('supplier_bill_template_field.label.field_comment') }}</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ trans('supplier_bill_template_field.label.field_default') }}</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ trans('supplier_bill_template_field.label.field_mark') }}</label>
            <div class="layui-input-inline">
                <select name="field_mark" class="layui-select search_key">
                    <option value="">{{ trans('app.empty') }}</option>
                    @foreach(trans('supplier_bill_template_field.field_mark') as $key => $field_mark)
...
<script>
    var main_url = "{{guard_url('supplier_bill_template_field')}}";
    var delete_all_url = "{{guard_url('supplier_bill_template_field/destroyAll')}}";
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'name',title:'{{ trans('supplier.name') }}'}
                ,{field:'field',title:'{{ trans('supplier_bill_template_field.label.field') }}',edit:'text'}
                ,{field:'field_comment',title:'{{ trans('supplier_bill_template_field.label.field_comment') }}',edit:'text'}
                ,{field:'field_default',title:'{{ trans('supplier_bill_template_field.label.field_default') }}',edit:'text'}
                ,{field:'field_mark',title:'{{ trans('supplier_bill_template_field.label.field_mark') }}'}
            ...
            if(obj.event === 'ajax_edit'){
                ...
                layer.open({
                    ...
                    btn1:function()
                    {
                        ...
                        console.log(data)
                        $.ajax({
                            url : "{{ guard_url('supplier_bill_template_field') }}/"+data.id,
                            data : form_data,
                            type : 'PUT',
                            success : function (data) {
                                layer.closeAll();
