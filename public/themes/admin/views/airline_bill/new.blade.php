    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                ...
                <div class="layui-inline">
                    <input class="layui-input search_key" name="sn" id="sn" placeholder="{{ trans('airline_bill.label.sn') }}" autocomplete="off">
                </div>
                <div class="layui-inline">
                    <input class="layui-input search_key" name="agreement_no" id="agreement_no" placeholder="{{ trans('airline_bill.label.agreement_no') }}" autocomplete="off">
                </div>
