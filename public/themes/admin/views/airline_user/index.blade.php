<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a href="{{ guard_url('airline_user') }}"><cite>{{ trans('airline_user.title') }}</cite></a>
        </div>
    </div>
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('airline_user/create')}}">{{ trans('app.add') }}</a></button>
...
<script>
    var main_url = "{{guard_url('airline_user')}}";
    var delete_all_url = "{{guard_url('airline_user/destroyAll')}}";
