    ...
    layui.use(['jquery','element','table','laydate'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'remark',title:'{{ trans('airline_bill.label.remark') }}',edit:'text',fixed: 'right',width:120}
                ,{field:'status_button',title:'{{ trans('app.status') }}', width:100, fixed: 'right'}
                ,{field:'score',title:'{{ trans('app.actions') }}', width:430, align: 'right',toolbar:'#barDemo', fixed: 'right'}
            ]]
            ,id: 'fb-table'
            ,page: true
