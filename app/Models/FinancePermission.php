...
use App\Traits\FinanceRoles\PermissionHasRelations;

class FinancePermission extends BaseModel
{
     ...
     * @var array
     */
     protected $config = 'model.finance_roles.finance_permission.model';
