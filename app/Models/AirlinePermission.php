...
use App\Traits\AirlineRoles\PermissionHasRelations;

class AirlinePermission extends BaseModel
{
     ...
     * @var array
     */
     protected $config = 'model.airline_roles.airline_permission.model';
