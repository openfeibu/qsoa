...
use App\Traits\SupplierRoles\HasRoleAndPermission;
use App\Contracts\AdminUserPolicy;
use App\Traits\AdminUser\AdminUser as AdminUserProfile;

class SupplierUser extends AuthModel implements AdminUserPolicy
{
     ...
     * @var array
     */
    protected $config = 'model.supplier_user.supplier_user.model';
