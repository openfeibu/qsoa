...
use App\Traits\SupplierRoles\PermissionHasRelations;

class SupplierPermission extends BaseModel
{
     ...
     * @var array
     */
     protected $config = 'model.supplier_roles.supplier_permission.model';
