...
use App\Traits\AirlineRoles\HasRoleAndPermission;
use App\Contracts\AdminUserPolicy;
use App\Traits\AdminUser\AdminUser as AdminUserProfile;

class AirlineUser extends AuthModel implements AdminUserPolicy
{
     ...
     * @var array
     */
    protected $config = 'model.airline_user.airline_user.model';
