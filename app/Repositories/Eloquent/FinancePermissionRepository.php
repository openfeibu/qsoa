...
use App\Repositories\Eloquent\FinancePermissionRepositoryInterface;
use App\Repositories\Eloquent\BaseRepository;


class FinancePermissionRepository extends BaseRepository implements FinancePermissionRepositoryInterface
{


    public function boot()
    {
        $this->fieldSearchable = config('model.finance_roles.finance_permission.model.search');
    ...
    {
        return config('model.finance_roles.finance_permission.model.model');
    }
