...
use App\Repositories\Eloquent\SupplierPermissionRepositoryInterface;
use App\Repositories\Eloquent\BaseRepository;


class SupplierPermissionRepository extends BaseRepository implements SupplierPermissionRepositoryInterface
{


    public function boot()
    {
        $this->fieldSearchable = config('model.supplier_roles.supplier_permission.model.search');
    ...
    {
        return config('model.supplier_roles.supplier_permission.model.model');
    }
