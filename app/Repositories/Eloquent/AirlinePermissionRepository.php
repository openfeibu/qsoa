...
use App\Repositories\Eloquent\AirlinePermissionRepositoryInterface;
use App\Repositories\Eloquent\BaseRepository;


class AirlinePermissionRepository extends BaseRepository implements AirlinePermissionRepositoryInterface
{


    public function boot()
    {
        $this->fieldSearchable = config('model.airline_roles.airline_permission.model.search');
    ...
    {
        return config('model.airline_roles.airline_permission.model.model');
    }
