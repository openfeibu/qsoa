 ...
 */
class FinancePermissionPresenter extends FractalPresenter
{
    protected $permission;

    public function __construct(FinancePermissionRepositoryInterface $permission)
    {
    ...
    {
        return new FinancePermissionTransformer();
    }
    /**
     * 用户根据权限可见的菜单
     * @return string
