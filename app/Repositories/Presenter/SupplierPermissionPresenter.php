 ...
 */
class SupplierPermissionPresenter extends FractalPresenter
{
    protected $permission;

    public function __construct(SupplierPermissionRepositoryInterface $permission)
    {
    ...
    {
        return new SupplierPermissionTransformer();
    }
    /**
     * 用户根据权限可见的菜单
     * @return string
