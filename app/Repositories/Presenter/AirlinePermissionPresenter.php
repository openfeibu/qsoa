 ...
 */
class AirlinePermissionPresenter extends FractalPresenter
{
    protected $permission;

    public function __construct(AirlinePermissionRepositoryInterface $permission)
    {
    ...
    {
        return new AirlinePermissionTransformer();
    }
    /**
     * 用户根据权限可见的菜单
     * @return string
