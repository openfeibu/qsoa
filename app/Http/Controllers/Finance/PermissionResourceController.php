...
use App\Http\Requests\FinancePermissionRequest;
...
class PermissionResourceController extends BaseController
{
     ...
     * @return null
     */
    public function __construct(FinancePermissionRepository $permission)
    {
        parent::__construct();
    ...
    /**
     * @param Request $request
     * @param FinancePermission $permission
     * @return mixed
     */
    public function show(Request $request, FinancePermission $permission)
    {
     ...
     * @return Response
     */
    public function edit(Request $request, FinancePermission $permission)
    {
     ...
     * @return Response
     */
    public function update(Request $request, FinancePermission $permission)
    {
        try {
            $attributes = $request->all();
     ...
     * @return mixed
     */
    public function destroy(Request $request, FinancePermission $permission)
    {
        try {
