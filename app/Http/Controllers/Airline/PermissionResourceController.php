...
use App\Http\Requests\AirlinePermissionRequest;
...
class PermissionResourceController extends BaseController
{
     ...
     *
     * @param type AirlinePermissionRepository $permission
     *
     * @return null
     */
    public function __construct(AirlinePermissionRepository $permission)
    {
        parent::__construct();
    ...
    /**
     * @param Request $request
     * @param AirlinePermission $permission
     * @return mixed
     */
    public function show(Request $request, AirlinePermission $permission)
    {
     ...
     * @return Response
     */
    public function edit(Request $request, AirlinePermission $permission)
    {
     ...
     * @return Response
     */
    public function update(Request $request, AirlinePermission $permission)
    {
        try {
            $attributes = $request->all();
     ...
     * @return mixed
     */
    public function destroy(Request $request, AirlinePermission $permission)
    {
        try {
