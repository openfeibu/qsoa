...
class RoleResourceController extends BaseController
{
     ...
     *
     * @param type AirlineRoleRepository $role
     * @param type AirlinePermissionRepository$permission
     *
     */
    public function __construct(
        AirlineRoleRepository $role,
        AirlinePermissionRepository $permission
    ) {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data = $this->repository
                ->orderBy('id','asc')
                ->setPresenter(\App\Repositories\Presenter\AirlineRoleListPresenter::class)
                ->getDataTable($limit);
     ...
     *
     * @param Request $request
     * @param AirlineRole   $role
     *
     * @return Response
     */
    public function show(Request $request, AirlineRole $role)
    {
        if ($role->exists) {
            $view = 'role.show';
        } else {
     ...
     * @return Response
     */
    public function edit(Request $request, AirlineRole $role)
    {
     ...
     * @return Response
     */
    public function update(Request $request, AirlineRole $role)
    {
        try {
            $attributes = $request->all();
     ...
     * @return Response
     */
    public function destroy(Request $request, AirlineRole $role)
    {
        try {
            $role->forceDelete();
