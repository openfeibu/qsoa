...
use App\Http\Requests\SupplierPermissionRequest;
use Illuminate\Http\Request;
use App\Repositories\Eloquent\SupplierPermissionRepository;
use App\Models\SupplierPermission;
/**
...
class PermissionResourceController extends BaseController
{
     ...
     *
     * @param type SupplierPermissionRepository $permission
     *
     * @return null
     */
    public function __construct(SupplierPermissionRepository $permission)
    {
        parent::__construct();
    ...
    /**
     * @param Request $request
     * @param SupplierPermission $permission
     * @return mixed
     */
    public function show(Request $request, SupplierPermission $permission)
    {
     ...
     * @return Response
     */
    public function edit(Request $request, SupplierPermission $permission)
    {
     ...
     * @return Response
     */
    public function update(Request $request, SupplierPermission $permission)
    {
        try {
            $attributes = $request->all();
     ...
     * @return mixed
     */
    public function destroy(Request $request, SupplierPermission $permission)
    {
        try {
