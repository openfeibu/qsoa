...
class RoleResourceController extends BaseController
{
     ...
     *
     * @param type SupplierRoleRepository $role
     * @param type SupplierPermissionRepository$permission
     *
     */
    public function __construct(
        SupplierRoleRepository $role,
        SupplierPermissionRepository $permission
    ) {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data = $this->repository
                ->orderBy('id','asc')
                ->setPresenter(\App\Repositories\Presenter\SupplierRoleListPresenter::class)
                ->getDataTable($limit);
     ...
     * @return Response
     */
    public function show(Request $request, SupplierRole $role)
    {
        if ($role->exists) {
            $view = 'role.show';
        } else {
     ...
     * @return Response
     */
    public function edit(Request $request, SupplierRole $role)
    {
     ...
     * @return Response
     */
    public function update(Request $request, SupplierRole $role)
    {
        try {
            $attributes = $request->all();
     ...
     * @return Response
     */
    public function destroy(Request $request, SupplierRole $role)
    {
        try {
            $role->forceDelete();
